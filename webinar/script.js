...
form.addEventListener('submit', async function(e) {
  ...
  try {
    ...
    <p class="text-jh">${result}<p>
    <a href="https://chat.whatsapp.com/LmqshL6PHIW6kP2me1D9Ip">👉 Únete a nuestro grupo aquí</a>
    <a href="https://jhely.com">👉 Conoce nuestra plataforma aquí</a>
    `;
    form.reset();
  } catch (error) {
